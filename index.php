...
//	L.marker([48.87, 2.225],{ icon:  park_blue}).addTo(map);
	...
	L.geoJSON(parking_blue, {onEachFeature: onEachFeature, pointToLayer: function(feature, latlon) {return L.marker(latlon, { icon:  park_blue});}}).addTo(map);
	L.geoJSON(parking_green, {onEachFeature: onEachFeature, pointToLayer: function(feature, latlon) {return L.marker(latlon, { icon:  park_green});}}).addTo(map);
